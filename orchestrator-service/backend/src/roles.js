...
Карта проекта и карта микросервиса уже даны тебе в контексте задачи (раздел
«Карта проекта»). Это твой первичный источник структуры — НЕ переоткрывай
устройство проекта широкими поисками.

Дисциплина чтения (держись жёстко):
1. Сначала опирайся на готовые карты (проект → сервис): они заменяют разведку структуры.
