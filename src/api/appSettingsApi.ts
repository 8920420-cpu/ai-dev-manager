...
export interface AppSettings {
  ...
  /**
   * TASK-AUTO-ACCEPT-001 — «не проверять выполненные задачи»: когда true,
   * дошедшие до DONE задачи авто-принимаются (гейт «Проверка» отключён). По
   * умолчанию false — DONE ждут ручного подтверждения в «Задачи → Проверка».
   */
