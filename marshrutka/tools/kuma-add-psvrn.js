// Роутер №3 «ПС» (psvrn.keenetic.link): мониторы ping/SSH/веб.
...
const monitors = [
  { ...base, type: "ping", name: "ПС: ping", hostname: "psvrn.keenetic.link" },
  { ...base, type: "port", name: "ПС: SSH (22)", hostname: "psvrn.keenetic.link", port: 22 },
  { ...base, type: "http", name: "ПС: веб-конфигуратор (443)", url: "https://psvrn.keenetic.link", expiryNotification: true },
];
